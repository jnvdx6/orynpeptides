...
export async function generateMetadata({
  ...
  const title = `Buy ${catName} Peptides in ${city.name} | ORYN \u2014 ${deliveryLabel}-Day Delivery`;
  const description = `Order research-grade ${catName.toLowerCase()} peptide pens in ${city.name}, ${city.region}. ${city.deliveryDays}-day delivery, >99% purity. ${productNames}.`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `${SITE_URL}/en/peptides-for/${catSlug}/${citySlug}`,
      },
    },
  };
}
