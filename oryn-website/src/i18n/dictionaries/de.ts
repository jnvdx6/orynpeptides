...
const de = {
  ...
  hero: {
    ...
    subtitle: "Forschungsqualität Peptide. Vordosiert. Morgen geliefert.",
    description:
  ...
  productDetail: {
    ...
    addToCart: "IN DEN WARENKORB",
    buyNow: "JETZT KAUFEN",
    orPayInstantly: "ODER SOFORT BEZAHLEN",
  ...
  products: {
    "bpc-157": {
      subtitle: "Forschungspeptid für Regeneration",
      categoryLabel: "Peptide Pen",
      description:
        "Body Protection Compound-157 ist ein synthetisches Pentadekapeptid, das von einem natürlich vorkommenden Protein im Magensaft abgeleitet ist. ORYN BPC-157 ist in pharmazeutischer Qualität in einem präzisionsdosierten Pen-System für konsistente, zuverlässige Verabreichung über 30 Tage formuliert.",
      benefits: [
        "Untersucht für Geweberegeneration und Erholungspfade",
        "Erforscht für gastrointestinale Schleimhautintegrität",
        "Forschungsschwerpunkt Sehnen- und Bänderreparaturmechanismen",
        "Untersucht für entzündungshemmende Signalwegmodulation",
        "Erforscht für neuroprotektive Mechanismen",
      ],
      badge: "Bestseller",
    },
    "tb-500": {
      subtitle: "Forschungspeptid für Zellmigration",
      categoryLabel: "Peptide Pen",
      description:
        "Thymosin Beta-4-Fragment, TB-500, wird umfassend für seine Rolle bei Zellmigration und Geweberegeneration erforscht. ORYN TB-500 liefert eine präzise 15mg-Dosis in unserem fortschrittlichen Pen-System, entwickelt für optimale Bioverfügbarkeit und konsistente Ergebnisse.",
      benefits: [
        "Untersucht für Wundverschlussforschung",
        "Erforscht für entzündliche Signalwegmodulation",
        "Forschungsschwerpunkt Muskelgeweberegeneration",
        "Untersucht in kardiovaskulären Gewebemodellen",
        "Erforscht für Flexibilitäts- und Mobilitätsforschung",
      ],
    },
    "cjc-1295": {
      subtitle: "GH-Sekretagog-Forschungspeptid",
      categoryLabel: "Peptide Pen",
      description:
        "CJC-1295 ist ein synthetisches Analogon des Wachstumshormon-Releasing-Hormons (GHRH). ORYN CJC-1295 wird untersucht für anhaltende GH-Signalwegmodulation durch unser Präzisionsdosierungssystem, hergestellt nach höchsten pharmazeutischen Standards.",
      benefits: [
        "Untersucht für Wachstumshormon-Freisetzungspfade",
        "Erforscht für Körperzusammensetzungsforschung",
        "Forschungsschwerpunkt Schlafarchitektur und GH-Pulsatilität",
        "Untersucht für Erholungspfad-Modulation",
        "Erforscht für Stoffwechselfunktionsforschung",
      ],
    },
    ipamorelin: {
      subtitle: "Selektives GH-Sekretagogum",
      categoryLabel: "Peptide Pen",
      description:
        "Ipamorelin ist ein selektives Wachstumshormon-Sekretagogum, das für die Stimulation der hypophysären GH-Freisetzung untersucht wird. ORYN Ipamorelin wird erforscht für gezielte GH-Modulation ohne die breitere hormonelle Störung, die bei weniger selektiven Verbindungen auftritt.",
      benefits: [
        "Untersucht für selektive GH-Freisetzungspfade",
        "Erforscht für sein selektives Rezeptorprofil",
        "Forschungsschwerpunkt Knochendichte-Anwendungen",
        "Untersucht für Magergewebeforschung",
        "Erforscht für Schlafqualitätsforschung",
      ],
    },
    "tirzepatide-pen": {
      subtitle: "Duales Inkretin-Forschungspeptid",
      categoryLabel: "Peptide Pen",
      description:
      ...
      benefits: [
        "Dualer Rezeptoragonismus für Stoffwechselforschung",
        "Erforscht für metabolische Signalwegmodulation",
        "Untersucht für Glukose-Homöostase-Forschung",
        "Forschungsschwerpunkt Appetit-Signalwege",
        "Umfassend erforschte Verbindung in klinischen Studien",
      ],
      badge: "Beliebt",
    },
    "ghk-cu": {
      subtitle: "Kupferpeptid-Forschungsverbindung",
      categoryLabel: "Peptide Pen",
      description:
        "GHK-Cu (Kupferpeptid) ist ein natürlich vorkommendes Tripeptid mit hoher Affinität für Kupferionen. ORYN GHK-CU wird untersucht für Hautmodellierung und Gewebereparaturforschung mit einer potenten 60mg-Formulierung.",
      benefits: [
        "Untersucht für Kollagensynthese-Signalwege",
        "Erforscht für Hautelastizität und Modellierungsforschung",
        "Forschungsschwerpunkt antioxidative Mechanismen",
        "Untersucht für Wundverschlussforschung",
        "Erforscht für Genexpressionsmodulation",
      ],
    },
    glutathione: {
      subtitle: "Antioxidatives Forschungstripeptid",
      categoryLabel: "Peptide Pen",
      description:
        "Glutathion ist ein wichtiges endogenes Antioxidans, das umfassend für seine Rolle bei zellulärer Entgiftung und Redox-Balance erforscht wird. ORYN Glutathion liefert eine forschungsreine 6g-Dosis über unser Präzisions-Pen-System für verbesserte Bioverfügbarkeit.",
      benefits: [
        "Untersucht für antioxidative Abwehrforschung",
        "Erforscht für zelluläre Entgiftungspfade",
        "Forschungsschwerpunkt Immunsystem-Modulation",
        "Untersucht für Hautdepigmentierungsmechanismen",
        "Erforscht für Leberfunktionsforschung",
      ],
    },
    "nad-plus": {
      subtitle: "Zelluläre Coenzym-Forschung",
      categoryLabel: "Peptide Pen",
      description:
        "Nicotinamid-Adenin-Dinukleotid (NAD+) ist ein essentielles Coenzym, das in jeder Zelle vorkommt. Der ORYN NAD+ Pen liefert eine konzentrierte 500mg-Dosis, untersucht für zellulären Energiestoffwechsel, DNA-Reparaturpfade und Alterungsforschung.",
      benefits: [
        "Untersucht für zellulären Energiestoffwechsel",
        "Erforscht für DNA-Reparaturpfad-Forschung",
        "Forschungsschwerpunkt gesunde Alterungsmechanismen",
        "Untersucht für kognitive Funktionsforschung",
        "Erforscht für Stoffwechselpfad-Effizienz",
      ],
      badge: "Premium",
    },
    "medit-tirzepatide": {
      subtitle: "Tirzepatide 40mg — Metabolischer Forschungspen",
      categoryLabel: "MediT Pen",
      description:
        "Der ORYN MediT Pen ist ein vorgefüllter Einweg-Injektionspen mit 40mg Tirzepatide. Für die einmal wöchentliche Anwendung in metabolischen Forschungsprotokollen konzipiert, mit dualem GIP/GLP-1-Rezeptoragonismus.",
      benefits: [
        "Dualer Rezeptoragonismus (GIP + GLP-1) für Stoffwechselforschung",
        "Einmal wöchentliche Anwendung",
        "Umfassend erforscht in SURPASS/SURMOUNT klinischen Studien",
        "Untersucht für Appetit- und Sättigungspfad-Modulation",
        "Erforscht für Glukose-Homöostase-Forschung",
        "Forschungsschwerpunkt langfristige metabolische Ergebnisse",
        "Untersucht in kardiovaskulären Risikofaktor-Studien",
      ],
      badge: "Neu",
    },
    "novadose-nad": {
      subtitle: "Fortschrittliches NAD+-Verabreichungssystem",
      categoryLabel: "NovaDose System",
      description:
        "NovaDose liefert pharmazeutisches NAD+ über ein innovatives kartuschenbasiertes Pen-System. Entwickelt für präzise tägliche Mikrodosierung in Forschungsprotokollen, wird es untersucht für zelluläre Energie-, Stoffwechseleffizienz- und Reparaturpfad-Forschung. Konzipiert für nachhaltige NAD+-Forschungsprotokolle.",
      benefits: [
        "Pharmazeutisches NAD+ aus Korea",
        "Präzise tägliche Mikrodosierung",
        "Nahezu 100% Bioverfügbarkeit für Forschungsanwendungen",
        "Untersucht für zelluläre Energie- und Stoffwechselforschung",
        "Erforscht für kognitive Leistungs- und Erholungsforschung",
        "Kostengünstige Alternative zu IV-basierten Forschungsprotokollen",
  ...
  researchCategories: {
    recovery: "Erholungsforschung",
    "weight-loss": "Stoffwechselforschung",
    "anti-aging": "Langlebigkeitsforschung",
    "muscle-growth": "Muskelgewebeforschung",
    "skin-rejuvenation": "Hautbiologieforschung",
    "sleep-quality": "Schlaf- & Erholungsforschung",
    "gut-health": "Darmforschung",
    "joint-health": "Gelenk- & Sehnenforschung",
    "hair-growth": "Haarfollikelforschung",
    "immune-support": "Immunforschung",
    "tendon-repair": "Sehnenforschung",
    "sports-recovery": "Sporterholungsforschung",
    "post-surgery": "Postoperative Forschung",
    "cognitive-enhancement": "Kognitive Forschung",
    "energy-vitality": "Energie- & Stoffwechselforschung",
    "detox-cleanse": "Entgiftungsforschung",
    "body-composition": "Körperzusammensetzungsforschung",
    inflammation: "Entzündungsforschung",
    "hormonal-balance": "Hormonforschung",
    "longevity-biohacking": "Langlebigkeits- & Biohacking-Forschung",
  },
