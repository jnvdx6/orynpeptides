...
const fr = {
  ...
  hero: {
    ...
    subtitle: "Peptides de Qualité Recherche. Pré-Dosés. Livrés Demain.",
    description:
    ...
    shopFrom: "ACHETER DÈS",
    offerPill: "1ÈRE COMMANDE : 10% DE RÉDUCTION — Code WELCOME10",
    urgencyLine: "Livraison gratuite dès 175€ d'achat",
    bestsellerBadge: "BEST-SELLER",
    bestsellerLine: "BPC-157 — Notre Peptide de Recherche #1",
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Paiement rapide via Stripe. Livraison gratuite en France pour les commandes de plus de 175€.",
      },
      {
  ...
  productDetail: {
    ...
    orPayInstantly: "OU PAYER INSTANTANÉMENT",
    ...
    freeShippingBadge: "LIVRAISON GRATUITE €175+",
  ...
  products: {
    "bpc-157": {
      subtitle: "Peptide de Recherche en Régénération",
      categoryLabel: "Peptide Pen",
      description:
        "Le Body Protection Compound-157 est un pentadécapeptide synthétique dérivé d'une protéine naturellement présente dans le suc gastrique. ORYN BPC-157 est formulé à qualité pharmaceutique dans un système de stylo à dosage de précision pour une administration constante et fiable sur 30 jours.",
      benefits: [
        "Étudié pour les voies de régénération et de récupération tissulaire",
        "Étudié pour la recherche sur l'intégrité de la muqueuse gastro-intestinale",
        "Recherche axée sur les mécanismes de réparation des tendons et ligaments",
        "Fait l'objet de recherches pour la modulation des voies anti-inflammatoires",
        "Étudié pour les mécanismes neuroprotecteurs",
      ],
      badge: "Best Seller",
    },
    "tb-500": {
      subtitle: "Peptide de Recherche en Migration Cellulaire",
      categoryLabel: "Peptide Pen",
      description:
        "Le fragment de Thymosin Bêta-4, TB-500, est largement étudié pour son rôle dans la migration cellulaire et la régénération tissulaire. ORYN TB-500 délivre une dose précise de 15 mg dans notre système de stylo avancé, conçu pour une biodisponibilité optimale et des résultats constants.",
      benefits: [
        "Fait l'objet de recherches pour la fermeture des plaies",
        "Étudié pour la modulation des voies inflammatoires",
        "Recherche axée sur la régénération du tissu musculaire",
        "Fait l'objet de recherches dans des modèles de tissu cardiovasculaire",
        "Étudié pour la recherche en flexibilité et mobilité",
      ],
    },
    "cjc-1295": {
      subtitle: "Peptide de Recherche Sécrétagogue de GH",
      categoryLabel: "Peptide Pen",
      description:
        "Le CJC-1295 est un analogue synthétique de l'hormone de libération de l'hormone de croissance (GHRH). ORYN CJC-1295 est étudié pour la modulation soutenue de la voie GH grâce à notre système de dosage de précision, fabriqué selon les plus hauts standards pharmaceutiques.",
      benefits: [
        "Fait l'objet de recherches pour les voies de libération de l'hormone de croissance",
        "Étudié pour la recherche en composition corporelle",
        "Recherche axée sur l'architecture du sommeil et la pulsatilité de la GH",
        "Fait l'objet de recherches pour la modulation des voies de récupération",
        "Étudié pour la recherche en fonction métabolique",
      ],
    },
    ipamorelin: {
      subtitle: "Sécrétagogue Sélectif de GH",
      categoryLabel: "Peptide Pen",
      description:
        "L'Ipamorelin est un sécrétagogue sélectif de l'hormone de croissance étudié pour stimuler la libération hypophysaire de GH. ORYN Ipamorelin est étudié pour la modulation ciblée de la GH sans la perturbation hormonale plus large observée avec des composés moins sélectifs.",
      benefits: [
        "Fait l'objet de recherches pour les voies sélectives de libération de GH",
        "Étudié pour son profil sélectif de récepteurs",
        "Recherche axée sur les applications de densité osseuse",
        "Fait l'objet de recherches pour la recherche en tissu maigre",
        "Étudié pour la recherche en qualité du sommeil",
      ],
    },
    "tirzepatide-pen": {
      subtitle: "Peptide de Recherche à Double Incrétine",
      categoryLabel: "Peptide Pen",
      description:
      ...
      benefits: [
        "Double agonisme des récepteurs pour la recherche métabolique",
        "Étudié pour la modulation des voies métaboliques",
        "Fait l'objet de recherches pour l'homéostasie du glucose",
        "Recherche axée sur les voies de signalisation de l'appétit",
        "Composé extensivement étudié dans les essais cliniques",
      ],
      badge: "Popular",
    },
    "ghk-cu": {
      subtitle: "Composé de Recherche au Peptide de Cuivre",
      categoryLabel: "Peptide Pen",
      description:
        "Le GHK-Cu (peptide de cuivre) est un tripeptide naturel ayant une forte affinité pour les ions cuivre. ORYN GHK-CU fait l'objet de recherches pour le remodelage cutané et la recherche en réparation tissulaire avec une formulation puissante de 60 mg.",
      benefits: [
        "Fait l'objet de recherches pour les voies de synthèse du collagène",
        "Étudié pour la recherche en élasticité et remodelage cutané",
        "Recherche axée sur les mécanismes antioxydants",
        "Fait l'objet de recherches pour la fermeture des plaies",
        "Étudié pour la modulation de l'expression génique",
      ],
    },
    glutathione: {
      subtitle: "Tripeptide Antioxydant de Recherche",
      categoryLabel: "Peptide Pen",
      description:
        "Le Glutathion est un antioxydant endogène clé, largement étudié pour son rôle dans la détoxification cellulaire et l'équilibre rédox. ORYN Glutathione délivre une dose de qualité recherche de 6 g via notre système de stylo de précision pour une biodisponibilité optimisée.",
      benefits: [
        "Fait l'objet de recherches pour la défense antioxydante",
        "Étudié pour les voies de détoxification cellulaire",
        "Recherche axée sur la modulation du système immunitaire",
        "Fait l'objet de recherches pour les mécanismes de dépigmentation cutanée",
        "Étudié pour la recherche en fonction hépatique",
      ],
    },
    "nad-plus": {
      subtitle: "Recherche sur la Coenzyme Cellulaire",
      categoryLabel: "Peptide Pen",
      description:
        "Le Nicotinamide Adénine Dinucléotide (NAD+) est un coenzyme essentiel présent dans chaque cellule. Le stylo ORYN NAD+ délivre une dose concentrée de 500 mg étudiée pour le métabolisme énergétique cellulaire, les voies de réparation de l'ADN et la recherche sur le vieillissement.",
      benefits: [
        "Fait l'objet de recherches pour le métabolisme énergétique cellulaire",
        "Étudié pour la recherche sur les voies de réparation de l'ADN",
        "Recherche axée sur les mécanismes du vieillissement en bonne santé",
        "Fait l'objet de recherches pour la recherche en fonction cognitive",
        "Étudié pour l'efficacité des voies métaboliques",
      ],
      badge: "Premium",
    },
    "medit-tirzepatide": {
      subtitle: "Tirzepatide 40mg — Stylo de Recherche Métabolique",
      categoryLabel: "MediT Pen",
      description:
        "Le MediT Pen ORYN est un stylo d'injection prérempli à usage unique contenant 40 mg de Tirzepatide. Conçu pour une administration hebdomadaire dans les protocoles de recherche métabolique, il présente un double agonisme des récepteurs GIP/GLP-1.",
      benefits: [
        "Double agonisme des récepteurs (GIP + GLP-1) pour la recherche métabolique",
        "Praticité d'administration hebdomadaire",
        "Extensivement étudié dans les essais cliniques SURPASS/SURMOUNT",
        "Fait l'objet de recherches pour la modulation des voies d'appétit et de satiété",
        "Étudié pour la recherche en homéostasie du glucose",
        "Recherche axée sur les résultats métaboliques à long terme",
        "Fait l'objet de recherches dans les études sur les facteurs de risque cardiovasculaire",
      ],
      badge: "Nouveau",
    },
    "novadose-nad": {
      subtitle: "Système Avancé d'Administration de NAD+",
      categoryLabel: "Système NovaDose",
      description:
        "NovaDose délivre du NAD+ de qualité pharmaceutique grâce à un système innovant de stylo à cartouches. Conçu pour un microdosage quotidien précis dans les protocoles de recherche, il fait l'objet de recherches pour l'énergie cellulaire, l'efficacité métabolique et les voies de réparation. Conçu pour des protocoles de recherche NAD+ soutenus.",
      benefits: [
        "NAD+ de qualité pharmaceutique de Corée",
        "Microdosage quotidien précis",
        "Biodisponibilité proche de 100% pour les applications de recherche",
        "Fait l'objet de recherches pour l'énergie cellulaire et la recherche métabolique",
        "Étudié pour la recherche en performance cognitive et récupération",
        "Alternative rentable aux protocoles de recherche basés sur IV",
  ...
  researchCategories: {
    recovery: "Recherche en Récupération",
    "weight-loss": "Recherche Métabolique",
    "anti-aging": "Recherche en Longévité",
    "muscle-growth": "Recherche en Tissu Musculaire",
    "skin-rejuvenation": "Recherche en Biologie Cutanée",
    "sleep-quality": "Recherche en Sommeil et Récupération",
    "gut-health": "Recherche Intestinale",
    "joint-health": "Recherche en Articulations et Tendons",
    "hair-growth": "Recherche en Follicule Capillaire",
    "immune-support": "Recherche Immunitaire",
    "tendon-repair": "Recherche en Tendons",
    "sports-recovery": "Recherche en Récupération Sportive",
    "post-surgery": "Recherche Post-Chirurgicale",
    "cognitive-enhancement": "Recherche Cognitive",
    "energy-vitality": "Recherche en Énergie et Métabolisme",
    "detox-cleanse": "Recherche en Détoxification",
    "body-composition": "Recherche en Composition Corporelle",
    inflammation: "Recherche en Inflammation",
    "hormonal-balance": "Recherche Hormonale",
    "longevity-biohacking": "Recherche en Longévité et Biohacking",
  },
  ...
  whyOrynPage: {
    differentiators: [
      ...
      { title: "Livraison Gratuite au Royaume-Uni pour les Commandes Supérieures à €175", description: "Profitez de la livraison gratuite le lendemain pour toutes les commandes britanniques supérieures à €175. L'emballage à température contrôlée garantit l'intégrité des peptides de nos installations à votre laboratoire de recherche.", highlight: "Livraison le lendemain" },
    ...
    comparisonFeatures: [
      ...
      { feature: "Livraison Royaume-Uni", oryn: "Gratuite au-dessus de €175 (le lendemain)", competitor: "Variable (€5–€15)" },
  ...
  shippingPage: {
    ...
    freeShippingExampleLabel: "EXEMPLE : COMMANDE DE \u20ac145",
