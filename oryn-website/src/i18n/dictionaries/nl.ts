...
const nl = {
  ...
  hero: {
    ...
    subtitle: "Research-Grade Peptiden. Voorgedoseerd. Morgen Geleverd.",
    description:
  ...
  productDetail: {
    ...
    addToCart: "IN WINKELWAGEN",
    buyNow: "NU KOPEN",
    orPayInstantly: "OF DIRECT BETALEN",
    adding: "TOEVOEGEN...",
  ...
  products: {
    "bpc-157": {
      subtitle: "Regeneratie Onderzoekspeptide",
      categoryLabel: "Peptide Pen",
      description:
        "Body Protection Compound-157 is een synthetisch pentadecapeptide afgeleid van een natuurlijk voorkomend eiwit in maagsap. ORYN BPC-157 is geformuleerd op farmaceutisch niveau in een precisie-gedoseerd pensysteem voor consistente, betrouwbare toediening gedurende 30 dagen.",
      benefits: [
        "Onderzocht voor weefselregeneratie en herstelpathways",
        "Bestudeerd voor gastro-intestinale mucosale integriteit onderzoek",
        "Onderzoeksfocus op pees- en ligamentreparatiemechanismen",
        "Onderzocht voor anti-inflammatoire pathway-modulatie",
        "Bestudeerd voor neuroprotectieve mechanismen",
      ],
      badge: "Bestseller",
    },
    "tb-500": {
      subtitle: "Celmigratie Onderzoekspeptide",
      categoryLabel: "Peptide Pen",
      description:
        "Thymosin Beta-4 fragment, TB-500, wordt uitgebreid bestudeerd voor zijn rol in celmigratie en weefselregeneratie. ORYN TB-500 levert een nauwkeurige dosis van 15mg in ons geavanceerde pensysteem, ontworpen voor optimale biologische beschikbaarheid en consistente resultaten.",
      benefits: [
        "Onderzocht voor wondsluiting onderzoek",
        "Bestudeerd voor inflammatoire pathway-modulatie",
        "Onderzoeksfocus op spierweefselregeneratie",
        "Onderzocht in cardiovasculaire weefselmodellen",
        "Bestudeerd voor flexibiliteit en mobiliteit onderzoek",
      ],
    },
    "cjc-1295": {
      subtitle: "GH Secretagoog Onderzoekspeptide",
      categoryLabel: "Peptide Pen",
      description:
        "CJC-1295 is een synthetisch analoog van groeihormoon-afgifte hormoon (GHRH). ORYN CJC-1295 wordt onderzocht voor aanhoudende GH-pathway-modulatie via ons precisiedoseringssysteem, geproduceerd volgens de hoogste farmaceutische normen.",
      benefits: [
        "Onderzocht voor groeihormoon-afgifte pathways",
        "Bestudeerd voor lichaamssamenstelling onderzoek",
        "Onderzoeksfocus op slaaparchitectuur en GH-pulsatiliteit",
        "Onderzocht voor herstel pathway-modulatie",
        "Bestudeerd voor metabole functie onderzoek",
      ],
    },
    ipamorelin: {
      subtitle: "Selectief GH Secretagoog",
      categoryLabel: "Peptide Pen",
      description:
        "Ipamorelin is een selectief groeihormoon secretagoog dat wordt onderzocht voor het stimuleren van hypofysaire GH-afgifte. ORYN Ipamorelin wordt bestudeerd voor gerichte GH-modulatie zonder de bredere hormonale verstoring die bij minder selectieve verbindingen optreedt.",
      benefits: [
        "Onderzocht voor selectieve GH-afgifte pathways",
        "Bestudeerd voor het selectieve receptorprofiel",
        "Onderzoeksfocus op botdichtheid toepassingen",
        "Onderzocht voor mager weefsel onderzoek",
        "Bestudeerd voor slaapkwaliteit onderzoek",
      ],
    },
    "tirzepatide-pen": {
      subtitle: "Dubbel Incretine Onderzoekspeptide",
      categoryLabel: "Peptide Pen",
      description:
      ...
      benefits: [
        "Dubbel receptor agonisme voor metabool onderzoek",
        "Bestudeerd voor metabole pathway-modulatie",
        "Onderzocht voor glucose homeostase onderzoek",
        "Onderzoeksfocus op eetlustsignaalpathways",
        "Uitgebreid bestudeerde verbinding in klinische studies",
      ],
      badge: "Populair",
    },
    "ghk-cu": {
      subtitle: "Koperpeptide Onderzoeksverbinding",
      categoryLabel: "Peptide Pen",
      description:
        "GHK-Cu (Koperpeptide) is een natuurlijk voorkomend tripeptide met een hoge affiniteit voor koperionen. ORYN GHK-CU wordt onderzocht voor huidremodellering en weefselherstel onderzoek met een krachtige 60mg formulering.",
      benefits: [
        "Onderzocht voor collageensynthese pathways",
        "Bestudeerd voor huidelasticiteit en remodellering onderzoek",
        "Onderzoeksfocus op antioxidant mechanismen",
        "Onderzocht voor wondsluiting onderzoek",
        "Bestudeerd voor genexpressie modulatie",
      ],
    },
    glutathione: {
      subtitle: "Antioxidant Onderzoeks-Tripeptide",
      categoryLabel: "Peptide Pen",
      description:
        "Glutathion is een belangrijke endogene antioxidant, uitgebreid bestudeerd voor zijn rol in cellulaire ontgifting en redoxbalans. ORYN Glutathion levert een onderzoeksgrade dosis van 6g via ons precisie-pensysteem voor verbeterde biologische beschikbaarheid.",
      benefits: [
        "Onderzocht voor antioxidant verdediging onderzoek",
        "Bestudeerd voor cellulaire ontgifting pathways",
        "Onderzoeksfocus op immuunsysteem modulatie",
        "Onderzocht voor huiddepigmentatie mechanismen",
        "Bestudeerd voor leverfunctie onderzoek",
      ],
    },
    "nad-plus": {
      subtitle: "Cellulair Co-enzym Onderzoek",
      categoryLabel: "Peptide Pen",
      description:
        "Nicotinamide Adenine Dinucleotide (NAD+) is een essentieel co-enzym aanwezig in elke cel. De ORYN NAD+ pen levert een geconcentreerde dosis van 500mg, onderzocht voor cellulair energiemetabolisme, DNA-reparatie pathways en verouderingsonderzoek.",
      benefits: [
        "Onderzocht voor cellulair energiemetabolisme",
        "Bestudeerd voor DNA-reparatie pathway onderzoek",
        "Onderzoeksfocus op gezond verouderen mechanismen",
        "Onderzocht voor cognitieve functie onderzoek",
        "Bestudeerd voor metabole pathway efficiëntie",
      ],
      badge: "Premium",
    },
    "medit-tirzepatide": {
      subtitle: "Tirzepatide 40mg — Metabool Onderzoekspen",
      categoryLabel: "MediT Pen",
      description:
        "De ORYN MediT Pen is een voorgevulde, enkelvoudige injectiepen met 40mg Tirzepatide. Ontworpen voor wekelijkse toediening in metabool onderzoeksprotocollen, met dubbel GIP/GLP-1 receptor agonisme.",
      benefits: [
        "Dubbel receptor agonisme (GIP + GLP-1) voor metabool onderzoek",
        "Eenmaal per week toedieningsgemak",
        "Uitgebreid bestudeerd in SURPASS/SURMOUNT klinische studies",
        "Onderzocht voor eetlust- en verzadiging pathway-modulatie",
        "Bestudeerd voor glucose homeostase onderzoek",
        "Onderzoeksfocus op langetermijn metabole uitkomsten",
        "Onderzocht in cardiovasculaire risicofactor studies",
      ],
      badge: "Nieuw",
    },
    "novadose-nad": {
      subtitle: "Geavanceerd NAD+ Afgiftesysteem",
      categoryLabel: "NovaDose System",
      description:
        "NovaDose levert farmaceutische NAD+ via een innovatief cartridge-gebaseerd pensysteem. Ontworpen voor nauwkeurige dagelijkse microdosering in onderzoeksprotocollen, wordt het onderzocht voor cellulaire energie, metabole efficiëntie en reparatie pathway onderzoek. Ontworpen voor langdurige NAD+ onderzoeksprotocollen.",
      benefits: [
        "Farmaceutische NAD+ uit Korea",
        "Nauwkeurige dagelijkse microdosering",
        "Bijna 100% biologische beschikbaarheid voor onderzoekstoepassingen",
        "Onderzocht voor cellulaire energie en metabool onderzoek",
        "Bestudeerd voor cognitieve prestaties en herstel onderzoek",
        "Kosteneffectief alternatief voor IV-gebaseerde onderzoeksprotocollen",
  ...
  researchCategories: {
    recovery: "Herstelonderzoek",
    "weight-loss": "Metabool Onderzoek",
    "anti-aging": "Langlevenonderzoek",
    "muscle-growth": "Spierweefsel Onderzoek",
    "skin-rejuvenation": "Huidbiologie Onderzoek",
    "sleep-quality": "Slaap & Herstel Onderzoek",
    "gut-health": "Darmonderzoek",
    "joint-health": "Gewricht & Pees Onderzoek",
    "hair-growth": "Haarfollikel Onderzoek",
    "immune-support": "Immuunonderzoek",
    "tendon-repair": "Peesonderzoek",
    "sports-recovery": "Sportherstel Onderzoek",
    "post-surgery": "Postchirurgisch Onderzoek",
    "cognitive-enhancement": "Cognitief Onderzoek",
    "energy-vitality": "Energie & Metabolisme Onderzoek",
    "detox-cleanse": "Detoxificatie Onderzoek",
    "body-composition": "Lichaamssamenstelling Onderzoek",
    inflammation: "Ontstekingsonderzoek",
    "hormonal-balance": "Hormonaal Onderzoek",
    "longevity-biohacking": "Langleven & Biohacking Onderzoek",
  },
  ...
  cookie: {
    ...
    marketingLabel: "Marketingcookies",
    savePreferences: "VOORKEUREN OPSLAAN",
    manageSettings: "BEHEREN",
    hideSettings: "INSTELLINGEN VERBERGEN",
    manageCookies: "Cookie-instellingen",
  },
