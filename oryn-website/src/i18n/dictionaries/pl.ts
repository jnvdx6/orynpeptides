...
const pl = {
  ...
  hero: {
    ...
    subtitle: "Peptydy Klasy Badawczej. Wstępnie Dozowane. Dostarczane Jutro.",
    description:
  ...
  productDetail: {
    ...
    addToCart: "DODAJ DO KOSZYKA",
    buyNow: "KUP TERAZ",
    orPayInstantly: "LUB ZAPŁAĆ OD RAZU",
    adding: "DODAWANIE...",
  ...
  products: {
    "bpc-157": {
      subtitle: "Peptyd badawczy regeneracji",
      categoryLabel: "Peptide Pen",
      description:
        "Body Protection Compound-157 to syntetyczny pentadekapeptyd pochodny naturalnie występującego białka z soku żołądkowego. ORYN BPC-157 jest formulowany w klasie farmaceutycznej w precyzyjnie dozowanym systemie pena, zapewniającym spójne i wiarygodne podawanie przez 30 dni.",
      benefits: [
        "Badany pod kątem regeneracji tkanek i szlaków regeneracyjnych",
        "Przebadany w zakresie integralności błony śluzowej przewodu pokarmowego",
        "Obszar badań: mechanizmy naprawy ścięgien i więzadeł",
        "Badany pod kątem modulacji szlaków przeciwzapalnych",
        "Przebadany w zakresie mechanizmów neuroprotekcyjnych",
      ],
      badge: "Bestseller",
    },
    "tb-500": {
      subtitle: "Peptyd badawczy migracji komórkowej",
      categoryLabel: "Peptide Pen",
      description:
        "Fragment Tymozyny Beta-4, TB-500, jest szeroko badany pod kątem jego roli w migracji komórkowej i regeneracji tkanek. ORYN TB-500 dostarcza precyzyjną dawkę 15mg w naszym zaawansowanym systemie pena, zaprojektowanym dla optymalnej biodostępności i spójnych wyników.",
      benefits: [
        "Badany pod kątem zamykania ran",
        "Przebadany w zakresie modulacji szlaków zapalnych",
        "Obszar badań: regeneracja tkanki mięśniowej",
        "Badany pod kątem modeli tkanki sercowo-naczyniowej",
        "Przebadany w zakresie elastyczności i mobilności",
      ],
    },
    "cjc-1295": {
      subtitle: "Peptyd badawczy sekretogog GH",
      categoryLabel: "Peptide Pen",
      description:
        "CJC-1295 to syntetyczny analog hormonu uwalniającego hormon wzrostu (GHRH). ORYN CJC-1295 jest badany pod kątem trwałej modulacji szlaku GH dzięki naszemu precyzyjnemu systemowi dawkowania, wytworzony według najwyższych standardów farmaceutycznych.",
      benefits: [
        "Badany pod kątem szlaków uwalniania hormonu wzrostu",
        "Przebadany w zakresie składu ciała",
        "Obszar badań: architektura snu i pulsacyjność GH",
        "Badany pod kątem modulacji szlaków regeneracyjnych",
        "Przebadany w zakresie funkcji metabolicznych",
      ],
    },
    ipamorelin: {
      subtitle: "Selektywny sekretogog GH",
      categoryLabel: "Peptide Pen",
      description:
        "Ipamorelin to selektywny sekretogog hormonu wzrostu badany pod kątem stymulacji uwalniania GH przez przysadkę mózgową. ORYN Ipamorelin jest badany pod kątem ukierunkowanej modulacji GH bez szerszych zaburzeń hormonalnych obserwowanych u mniej selektywnych związków.",
      benefits: [
        "Badany pod kątem szlaków selektywnego uwalniania GH",
        "Przebadany w zakresie selektywnego profilu receptorowego",
        "Obszar badań: zastosowania w gęstości kości",
        "Badany pod kątem tkanki beztłuszczowej",
        "Przebadany w zakresie jakości snu",
      ],
    },
    "tirzepatide-pen": {
      subtitle: "Peptyd badawczy podwójnej inkretyny",
      categoryLabel: "Peptide Pen",
      description:
      ...
      benefits: [
        "Podwójny agonizm receptorowy do badań metabolicznych",
        "Przebadany w zakresie modulacji szlaków metabolicznych",
        "Badany pod kątem homeostazy glukozy",
        "Obszar badań: szlaki sygnalizacji apetytu",
        "Związek szeroko przebadany w badaniach klinicznych",
      ],
      badge: "Popularny",
    },
    "ghk-cu": {
      subtitle: "Związek badawczy peptydu miedziowego",
      categoryLabel: "Peptide Pen",
      description:
        "GHK-Cu (peptyd miedziowy) to naturalnie występujący tripeptyd o wysokim powinowactwie do jonów miedzi. ORYN GHK-CU jest badany pod kątem przebudowy skóry i naprawy tkanek dzięki silnej formulacji 60mg.",
      benefits: [
        "Badany pod kątem szlaków syntezy kolagenu",
        "Przebadany w zakresie elastyczności i przebudowy skóry",
        "Obszar badań: mechanizmy antyoksydacyjne",
        "Badany pod kątem zamykania ran",
        "Przebadany w zakresie modulacji ekspresji genów",
      ],
    },
    glutathione: {
      subtitle: "Antyoksydacyjny tripeptyd badawczy",
      categoryLabel: "Peptide Pen",
      description:
        "Glutation to kluczowy endogenny antyoksydant, szeroko badany pod kątem jego roli w detoksykacji komórkowej i równowadze redoks. ORYN Glutation dostarcza dawkę klasy badawczej 6g poprzez nasz precyzyjny system pena dla zwiększonej biodostępności.",
      benefits: [
        "Badany pod kątem obrony antyoksydacyjnej",
        "Przebadany w zakresie szlaków detoksykacji komórkowej",
        "Obszar badań: modulacja układu odpornościowego",
        "Badany pod kątem mechanizmów depigmentacji skóry",
        "Przebadany w zakresie funkcji wątroby",
      ],
    },
    "nad-plus": {
      subtitle: "Badania nad koenzymem komórkowym",
      categoryLabel: "Peptide Pen",
      description:
        "Dinukleotyd nikotynamidoadeninowy (NAD+) to kluczowy koenzym obecny w każdej komórce. Pen ORYN NAD+ dostarcza skoncentrowaną dawkę 500mg badaną pod kątem metabolizmu energetycznego komórek, szlaków naprawy DNA i badań nad starzeniem.",
      benefits: [
        "Badany pod kątem metabolizmu energetycznego komórek",
        "Przebadany w zakresie szlaków naprawy DNA",
        "Obszar badań: mechanizmy zdrowego starzenia",
        "Badany pod kątem funkcji poznawczych",
        "Przebadany w zakresie wydajności szlaków metabolicznych",
      ],
      badge: "Premium",
    },
    "medit-tirzepatide": {
      subtitle: "Tirzepatide 40mg — Pen do badań metabolicznych",
      categoryLabel: "MediT Pen",
      description:
        "ORYN MediT Pen to napełniony, jednorazowy pen do iniekcji zawierający 40mg Tirzepatide. Przeznaczony do podawania raz w tygodniu w protokołach badań metabolicznych, z podwójnym agonizmem receptorów GIP/GLP-1.",
      benefits: [
        "Podwójny agonizm receptorowy (GIP + GLP-1) do badań metabolicznych",
        "Wygoda stosowania raz w tygodniu",
        "Szeroko przebadany w badaniach klinicznych SURPASS/SURMOUNT",
        "Badany pod kątem modulacji szlaków apetytu i sytości",
        "Przebadany w zakresie homeostazy glukozy",
        "Obszar badań: długoterminowe wyniki metaboliczne",
        "Badany pod kątem czynników ryzyka sercowo-naczyniowego",
      ],
      badge: "Nowość",
    },
    "novadose-nad": {
      subtitle: "Zaawansowany system dostarczania NAD+",
      categoryLabel: "NovaDose System",
      description:
        "NovaDose dostarcza NAD+ klasy farmaceutycznej poprzez innowacyjny system pena na bazie wkładów. Przeznaczony do precyzyjnego codziennego mikrodawkowania w protokołach badawczych, jest badany pod kątem energii komórkowej, wydajności metabolicznej i szlaków naprawczych. Zaprojektowany do długotrwałych protokołów badawczych NAD+.",
      benefits: [
        "NAD+ klasy farmaceutycznej z Korei",
        "Precyzyjne codzienne mikrodawkowanie",
        "Niemal 100% biodostępność do zastosowań badawczych",
        "Badany pod kątem energii komórkowej i metabolizmu",
        "Przebadany w zakresie wydajności poznawczej i regeneracji",
        "Opłacalna alternatywa dla protokołów badawczych opartych na IV",
  ...
  researchCategories: {
    recovery: "Badania nad Regeneracją",
    "weight-loss": "Badania Metaboliczne",
    "anti-aging": "Badania nad Długowiecznością",
    "muscle-growth": "Badania Tkanki Mięśniowej",
    "skin-rejuvenation": "Badania Biologii Skóry",
    "sleep-quality": "Badania Snu i Regeneracji",
    "gut-health": "Badania Jelit",
    "joint-health": "Badania Stawów i Ścięgien",
    "hair-growth": "Badania Mieszków Włosowych",
    "immune-support": "Badania Immunologiczne",
    "tendon-repair": "Badania Ścięgien",
    "sports-recovery": "Badania Regeneracji Sportowej",
    "post-surgery": "Badania Pooperacyjne",
    "cognitive-enhancement": "Badania Kognitywne",
    "energy-vitality": "Badania Energii i Metabolizmu",
    "detox-cleanse": "Badania Detoksykacji",
    "body-composition": "Badania Kompozycji Ciała",
    inflammation: "Badania Zapalenia",
    "hormonal-balance": "Badania Hormonalne",
    "longevity-biohacking": "Badania Długowieczności i Biohackingu",
  },
