...
const pt = {
  ...
  hero: {
    ...
    subtitle: "Péptidos de Qualidade de Investigação. Pré-Doseados. Entregues Amanhã.",
    description:
    ...
    offerPill: "PRIMEIRO PEDIDO: 10% DESCONTO — Código WELCOME10",
    urgencyLine: "Envio gratuito em encomendas acima de 175€",
    bestsellerBadge: "MAIS VENDIDO",
    bestsellerLine: "BPC-157 — O Nosso Péptido de Investigação #1",
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Pagamento rápido com Stripe. Envio gratuito em encomendas superiores a €175.",
      },
      {
  ...
  productDetail: {
    ...
    freeShippingBadge: "ENVIO GRATUITO €175+",
  ...
  products: {
    "bpc-157": {
      subtitle: "Peptídeo de Investigação de Regeneração",
      categoryLabel: "Peptide Pen",
      description:
        "O Body Protection Compound-157 é um pentadecapeptídeo sintético derivado de uma proteína natural do suco gástrico. O ORYN BPC-157 é formulado com grau farmacêutico num sistema de caneta de dosagem precisa para uma administração consistente e fiável durante 30 dias.",
      benefits: [
        "Investigado para vias de regeneração e recuperação tecidular",
        "Estudado para investigação da integridade da mucosa gastrointestinal",
        "Foco de investigação em mecanismos de reparação de tendões e ligamentos",
    ...
    "tb-500": {
      subtitle: "Peptídeo de Investigação de Migração Celular",
      categoryLabel: "Peptide Pen",
      description:
        "O fragmento de Timosina Beta-4, TB-500, é amplamente estudado pelo seu papel na migração celular e regeneração tecidular. O ORYN TB-500 fornece uma dose precisa de 15mg no nosso sistema avançado de caneta, projetado para biodisponibilidade ótima e resultados consistentes.",
      benefits: [
        "Investigado para investigação do encerramento de feridas",
        "Estudado para modulação de vias inflamatórias",
        "Foco de investigação em regeneração de tecido muscular",
        "Investigado em modelos de tecido cardiovascular",
        "Estudado para investigação de flexibilidade e mobilidade",
      ],
    },
    "cjc-1295": {
      subtitle: "Peptídeo de Investigação Secretagogo de GH",
      categoryLabel: "Peptide Pen",
      description:
        "O CJC-1295 é um análogo sintético da hormona libertadora de hormona de crescimento (GHRH). O ORYN CJC-1295 é investigado para modulação sustentada da via de GH através do nosso sistema de dosagem de precisão, fabricado segundo os mais elevados padrões farmacêuticos.",
      benefits: [
        "Investigado para vias de libertação de hormona de crescimento",
        "Estudado para investigação da composição corporal",
        "Foco de investigação em arquitectura do sono e pulsatilidade de GH",
        "Investigado para modulação de vias de recuperação",
        "Estudado para investigação da função metabólica",
      ],
    },
    ipamorelin: {
      ...
      categoryLabel: "Peptide Pen",
      description:
        "O Ipamorelin é um secretagogo seletivo de hormona de crescimento investigado para estimular a libertação de GH pela glândula pituitária. O ORYN Ipamorelin é estudado para modulação dirigida de GH sem a perturbação hormonal mais ampla observada em compostos menos seletivos.",
      benefits: [
        "Investigado para vias de libertação seletiva de GH",
        "Estudado pelo seu perfil seletivo de recetores",
        "Foco de investigação em aplicações de densidade óssea",
        "Investigado para investigação de tecido magro",
        "Estudado para investigação da qualidade do sono",
      ],
    },
    "tirzepatide-pen": {
      subtitle: "Peptídeo de Investigação de Dupla Incretina",
      categoryLabel: "Peptide Pen",
      description:
      ...
      benefits: [
        "Agonismo duplo de recetores para investigação metabólica",
        "Estudado para modulação de vias metabólicas",
        "Investigado para investigação da homeostase da glicose",
        "Foco de investigação em vias de sinalização do apetite",
        "Composto extensivamente estudado em ensaios clínicos",
      ],
      badge: "Popular",
    },
    "ghk-cu": {
      subtitle: "Composto de Investigação de Peptídeo de Cobre",
      categoryLabel: "Peptide Pen",
      description:
        "O GHK-Cu (peptídeo de cobre) é um tripeptídeo natural com alta afinidade para iões de cobre. O ORYN GHK-CU é investigado para investigação de remodelação cutânea e reparação tecidular com uma formulação potente de 60mg.",
      benefits: [
        "Investigado para vias de síntese de colagénio",
        "Estudado para investigação da elasticidade e remodelação cutânea",
        "Foco de investigação em mecanismos antioxidantes",
        "Investigado para investigação do encerramento de feridas",
        "Estudado para modulação da expressão génica",
      ],
    },
    glutathione: {
      subtitle: "Tripeptídeo Antioxidante de Investigação",
      categoryLabel: "Peptide Pen",
      description:
        "A Glutationa é um antioxidante endógeno chave, amplamente estudado pelo seu papel na desintoxicação celular e no equilíbrio redox. O ORYN Glutathione fornece uma dose de grau de investigação de 6g através do nosso sistema de caneta de precisão para biodisponibilidade melhorada.",
      benefits: [
        "Investigado para investigação da defesa antioxidante",
        "Estudado para vias de desintoxicação celular",
        "Foco de investigação em modulação do sistema imunitário",
        "Investigado para mecanismos de despigmentação cutânea",
        "Estudado para investigação da função hepática",
      ],
    },
    "nad-plus": {
      subtitle: "Investigação de Coenzima Celular",
      categoryLabel: "Peptide Pen",
      description:
        "A Nicotinamida Adenina Dinucleótido (NAD+) é uma coenzima essencial presente em todas as células. A caneta ORYN NAD+ fornece uma dose concentrada de 500mg investigada para o metabolismo energético celular, vias de reparação do ADN e investigação do envelhecimento.",
      benefits: [
        "Investigado para metabolismo energético celular",
        "Estudado para investigação de vias de reparação do ADN",
        "Foco de investigação em mecanismos de envelhecimento saudável",
        "Investigado para investigação da função cognitiva",
        "Estudado para eficiência de vias metabólicas",
      ],
      badge: "Premium",
    },
    "medit-tirzepatide": {
      subtitle: "Tirzepatide 40mg — Caneta de Investigação Metabólica",
      categoryLabel: "MediT Pen",
      description:
        "A ORYN MediT Pen é uma caneta de injeção pré-carregada de uso único contendo 40mg de Tirzepatide. Concebida para administração semanal em protocolos de investigação metabólica, apresenta agonismo duplo de recetores GIP/GLP-1.",
      benefits: [
        "Agonismo duplo de recetores (GIP + GLP-1) para investigação metabólica",
        ...
        "Estudado para investigação da homeostase da glicose",
        "Foco de investigação em resultados metabólicos a longo prazo",
    ...
    "novadose-nad": {
      ...
      description:
        "O NovaDose fornece NAD+ de grau farmacêutico através de um inovador sistema de caneta baseado em cartuchos. Concebido para microdosagem diária precisa em protocolos de investigação, é investigado para energia celular, eficiência metabólica e investigação de vias de reparação. Concebido para protocolos de investigação de NAD+ sustentados.",
      benefits: [
        "NAD+ de grau farmacêutico da Coreia",
        "Microdosagem diária precisa",
        "Biodisponibilidade próxima de 100% para aplicações de investigação",
        "Investigado para investigação de energia celular e metabolismo",
        "Estudado para investigação de desempenho cognitivo e recuperação",
        "Alternativa económica a protocolos de investigação baseados em IV",
  ...
  researchCategories: {
    recovery: "Investigação de Recuperação",
    "weight-loss": "Investigação Metabólica",
    "anti-aging": "Investigação de Longevidade",
    "muscle-growth": "Investigação de Tecido Muscular",
    "skin-rejuvenation": "Investigação de Biologia Cutânea",
    "sleep-quality": "Investigação de Sono e Recuperação",
    "gut-health": "Investigação Intestinal",
    "joint-health": "Investigação de Articulações e Tendões",
    "hair-growth": "Investigação de Folículos Capilares",
    "immune-support": "Investigação Imunitária",
    "tendon-repair": "Investigação de Tendões",
    "sports-recovery": "Investigação de Recuperação Desportiva",
    "post-surgery": "Investigação Pós-Cirúrgica",
    "cognitive-enhancement": "Investigação Cognitiva",
    "energy-vitality": "Investigação de Energia e Metabolismo",
    "detox-cleanse": "Investigação de Desintoxicação",
    "body-composition": "Investigação de Composição Corporal",
    inflammation: "Investigação de Inflamação",
    "hormonal-balance": "Investigação Hormonal",
    "longevity-biohacking": "Investigação de Longevidade e Biohacking",
  },
  ...
  homeFaq: {
    items: [
      ...
      { q: "Quanto tempo demora a entrega?", a: "As encomendas em Portugal chegam normalmente em 3-5 dias úteis. Encomendas europeias demoram 3-7 dias úteis conforme o destino. Todas as encomendas são enviadas em embalagem discreta e com temperatura controlada. Encomendas superiores a 175€ têm envio gratuito." },
  ...
  shippingFaq: {
    items: [
      ...
      { q: "Como me qualifico para envio gratuito?", a: "O envio padrão gratuito está disponível em todas as encomendas superiores a 175 euros. Este limiar aplica-se ao subtotal da encomenda antes de quaisquer códigos de desconto. As encomendas internacionais para a Europa estão sujeitas a uma taxa de envio fixa independentemente do valor da encomenda. O seu carrinho mostrará uma barra de progresso indicando o quanto falta para atingir o limiar de envio gratuito." },
  ...
  cookie: {
    ...
    manageSettings: "GERIR",
    hideSettings: "OCULTAR DEFINIÇÕES",
    manageCookies: "Definições de cookies",
  },
  ...
  popups: {
    firstVisit: {
      ...
      benefits: [
        "Envio gratuito a partir de 175€",
        "Fabrico certificado GMP",
  ...
  volumeDiscount: {
    ...
    maxTierReached: "Nível máximo de desconto por volume atingido!",
    eligible: "ELEGÍVEL",
    comingSoon: "Os descontos por volume estão a chegar em breve. Adicione mais artigos!",
  },
  ...
  whyOrynPage: {
    differentiators: [
      ...
      { title: "Envio Gratuito para o Reino Unido acima de €175", description: "Desfrute de entrega gratuita no dia seguinte em todos os pedidos do Reino Unido acima de €175. A embalagem com controlo de temperatura garante a integridade do péptido desde as nossas instalações até ao seu laboratório de investigação.", highlight: "Entrega no dia seguinte" },
    ...
    comparisonFeatures: [
      ...
      { feature: "Envio para o Reino Unido", oryn: "Gratuito acima de €175 (dia seguinte)", competitor: "Variável (€5-€15)" },
  ...
  shippingPage: {
    ...
    freeShippingExampleLabel: "EXEMPLO: ENCOMENDA DE \u20ac145",
